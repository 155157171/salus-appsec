...
program
  .name('salus')
  .description(
    'Salus — CLI de AppSec com IA (BYOK)\n' +
...
program
  .command('config')
  .description(
    'Configura o provedor LLM e a API Key.\n' +
...
program
  .command('analyze')
  .description(
    'Varredura completa de vulnerabilidades de segurança.\n' +
...
program
  .command('redteam')
  .description(
    'Análise ofensiva com mindset Red Team.\n' +
...
program
  .command('harden')
  .description(
    'Hardening defensivo com mindset Blue Team.\n' +
...
program
  .command('aisec')
  .description(
    'Auditoria de segurança para aplicações AI/LLM.\n' +
...
program
  .command('websec')
  .description(
    'Análise de segurança para aplicações web e APIs.\n' +
...
program
  ...
  .description(
    'Terminal interativo contínuo (REPL) do Salus.\n' +
    'Comandos internos:\n' +
